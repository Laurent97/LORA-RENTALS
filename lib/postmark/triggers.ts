...
import { bookingRef, buildBookingPickupUrl, buildBookingQrPayload, fmtDate, fmtDateTime, rentalDays } from "@/lib/utils";
...
function bookingData(b: Booking, v: Vehicle | null, customer: User | null, owner: User | null) {
  ...
  return {
    ...
    qr_payload: buildBookingPickupUrl(buildBookingQrPayload({
